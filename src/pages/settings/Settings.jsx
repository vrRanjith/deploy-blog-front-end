...
function Settings() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (file) {
      ...
      try {
        ...
        await axios.post("https://ublog-api.onrender.com/api/upload", data)
      } catch (err) {}
    } 
    try {
      const res = await axios.put("https://ublog-api.onrender.com/api/users/"+user._id, updatedUser)
  ...
  const PF = "https://ublog-api.onrender.com/images/"
